...
name, parameters) {
  ...
  const ref = (0, _utils.unstable_useForkRef)(internalRef,
  // @ts-ignore `ref` is required for the 'root' slot
  (0, _utils.unstable_useForkRef)(resolvedComponentsProps == null ? void 0 : resolvedComponentsProps.ref, name === 'root' ? parameters.ref : undefined));
